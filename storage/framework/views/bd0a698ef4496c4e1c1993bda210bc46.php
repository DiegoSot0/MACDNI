        ...
        <div class="container-box custom-border mt-4">
            <div class="text-center">
                <div class="image-container">
                    <img src="<?php echo e(asset('maclogo.png')); ?>" alt="Imagen" class="img-fluid m-5">
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function consultarDNI() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(url('/consulta-dni')); ?>",
                    data: {
                        'dni': dni
                    },
                    headers: {
...
<?php /**PATH C:\laragon\www\MACDNI\resources\views/index.blade.php ENDPATH**/ ?>